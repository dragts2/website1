...
case "La versione attuale e quella del file non coincidono":	$messaggio = "The current version and the one of the file are not the same"; break;
...
case "Includi le pagine per il sito web":  	$messaggio = "Include website pages"; break;
