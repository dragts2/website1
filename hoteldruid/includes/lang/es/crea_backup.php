...
case "La versione attuale e quella del file non coincidono":	$messaggio = "La versión actual y la del archivo no coinciden"; break;
...
case "Includi le pagine per il sito web":  	$messaggio = "Incluir las páginas para el sitio web"; break;
