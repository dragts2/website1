...
<righetabella>
<riga><cmp>65487</cmp><cmp>vett9</cmp><cmp>arr_link_ec;numero_cliente</cmp></riga>
<riga><cmp>65488</cmp><cmp>vett9</cmp><cmp>arr_link_en_ec;numero_cliente</cmp></riga>
<riga><cmp>65489</cmp><cmp>vett9</cmp><cmp>arr_dati_accesso_ec;numero_cliente</cmp></riga>
<riga><cmp>65490</cmp><cmp>vett9</cmp><cmp>arr_dati_accesso_en_ec;numero_cliente</cmp></riga>
...
<riga><cmp>65486</cmp><cmp>vett17</cmp><cmp>cliente_mostrato_csv;numero_cliente</cmp></riga>
...
<riga><cmp>65491</cmp><cmp>vett10</cmp><cmp>arr_link_eb;numero_cliente</cmp></riga>
<riga><cmp>65492</cmp><cmp>vett10</cmp><cmp>arr_link_en_eb;numero_cliente</cmp></riga>
...
<riga><cmp>490</cmp><cmp>var4</cmp><cmp>numero_invio_fael</cmp></riga>
<riga><cmp>488</cmp><cmp>var22</cmp><cmp>presenze_isa</cmp></riga>
<riga><cmp>489</cmp><cmp>var22</cmp><cmp>data_isa</cmp></riga>
...
<riga><cmp>491</cmp><cmp>var19</cmp><cmp>codice_nazione1_ross</cmp></riga>
<riga><cmp>492</cmp><cmp>var19</cmp><cmp>provincia_resid1_ross</cmp></riga>
<riga><cmp>493</cmp><cmp>var19</cmp><cmp>comune_resid1_ross</cmp></riga>
...
<riga><cmp>8</cmp><cmp>oggetto</cmp><cmp>mln_ita:Disponibilità>mln_en:Availability</cmp></riga>
<riga><cmp>9</cmp><cmp>oggetto</cmp><cmp>mln_ita:Conferma prenotazione>mln_en:Reservation confirmation</cmp></riga>
<riga><cmp>10</cmp><cmp>oggetto</cmp><cmp>mln_ita:La tua prenotazione si sta avvicinando>mln_en:Your reservation is approaching</cmp></riga>
...
le confermo che ho prenotato a suo nome un appartamento[c num_persone_tot!=""] per [num_persone_tot] persone[/c] per il periodo dal [data_inizio] al [data_fine]. Il prezzo per detto periodo e' di [costo_tot_p] [nome_valuta] (comprese le spese accessorie). Per completare la prenotazione è necessario versare un anticipo di [caparra_p] [nome_valuta], può effettuare il pagamento seguendo [c arr_link_ec(numero_cliente)=""]questo link[/c][c arr_link_ec(numero_cliente)!=""]questi link[/c]:

[arr_link_ec(numero_cliente)][url_base_pagine_web]mdl_conferma_prenotazione.php?cn=[cogn_no_sp_ec]&cp=[codice_prenotazione]

Se [c arr_link_ec(numero_cliente)=""]questo link non funzionasse[/c][c arr_link_ec(numero_cliente)!=""]questi link non funzionassero[/c] correttamente può provare ad utilizzare quest'altro:

[url_base_pagine_web]mdl_conferma_prenotazione.php

per poi inserire:

[arr_dati_accesso_ec(numero_cliente)]Cognome: [cognome]
...
[c allegato1!=""]ho allegato a questa e-mail un file con i nostri contatti e una mappa per aiutarvi a trovarci, per favore fatemi sapere se avete problemi a leggerlo.

[/c]Se volete risparmiare tempo al vostro arrivo, è possibile inserire i dati richiesti per il check-in da qui:

[arr_link_eb(numero_cliente)][url_base_pagine_web]mdl_conferma_prenotazione.php?cn=[cogn_no_sp_eb]&cp=[codice_prenotazione]&fe=1
...
I confirm you that I have reserved you an apartment[c people_num_tot!=""] for [people_num_tot] people[/c] in the period from [starting_date] to [ending_date]. The price for this period is [price_tot_p] [currency_name] (including cleaning and utilities). In order to complete the reservation you must send a down-payment of [deposit_p] [currency_name], you can pay it following [c arr_link_ec(numero_cliente)=""]this link[/c][c arr_link_ec(numero_cliente)!=""]these links[/c]:

[arr_link_en_ec(numero_cliente)][url_base_pagine_web]confirm_reservation_tpl.php?cn=[cogn_no_sp_ec]&cp=[codice_prenotazione]

If the above [c arr_link_ec(numero_cliente)=""]link does not[/c][c arr_link_ec(numero_cliente)!=""]links do not[/c] work properly for you, try this other one:

[url_base_pagine_web]confirm_reservation_tpl.php

and then insert:

[arr_dati_accesso_en_ec(numero_cliente)]Surname: [surname]
...
[c allegato1!=""]I’ve attached to this e-mail a file with our contacts and a map to help you find us, please let me know if you have problems reading it.

[/c]If you want to save time at your arrival you can fill in the data required for check-in from here:

[arr_link_en_eb(numero_cliente)][url_base_pagine_web]confirm_reservation_tpl.php?cn=[cogn_no_sp_eb]&cp=[codice_prenotazione]&fe=1
...
<riga><cmp>4</cmp><cmp>datdownl</cmp><cmp>xml>var</cmp></riga>
<riga><cmp>7</cmp><cmp>datdownl</cmp><cmp>xml></cmp></riga>
<riga><cmp>17</cmp><cmp>datdownl</cmp><cmp>csv></cmp></riga>
<riga><cmp>18</cmp><cmp>datdownl</cmp><cmp>csv></cmp></riga>
<riga><cmp>20</cmp><cmp>datdownl</cmp><cmp>xml></cmp></riga>
...
<p:FatturaElettronica versione="FPR12" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:p="http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2 http://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.2/Schema_del_file_xml_FatturaPA_versione_1.2.xsd">
  <FatturaElettronicaHeader>
    <DatiTrasmissione>
      ...
      <ProgressivoInvio>[numero_invio_fael]</ProgressivoInvio>
...
\cell\pard\plain \intbl\ltrpar\s1\cf0\ql\rtlch\afs24\lang255\ltrch\dbch\langfe255\hich\fs24\lang1040\loch\fs24\lang1040 
\cell\row\pard \trowd\trql\trleft276\trpaddft3\trpaddt55\trpaddfl3\trpaddl55\trpaddfb3\trpaddb55\trpaddfr3\trpaddr55\clbrdrl\brdrs\brdrw1\brdrcf1\clbrdrb\brdrs\brdrw1\brdrcf1\clcbpat2\cellx7792\clbrdrl\brdrs\brdrw1\brdrcf1\clbrdrb\brdrs\brdrw1\brdrcf1\clbrdrr\brdrs\brdrw1\brdrcf1\clcbpat2\clvertalb\cellx9637
\pard\intbl\pard\plain \intbl\ltrpar\s1{\*\hyphen2\hyphlead2\hyphtrail2\hyphmax0}\ql\rtlch\af1\afs24\lang255\ltrch\dbch\af1\langfe255\hich\f1\fs24\lang1040\loch\f1\fs24\lang1040 {\rtlch \ltrch\loch\f1\fs24\lang1040\i0\b0 [c data_inizio!=""]Prenotazione dal [data_inizio] al [data_fine][/c][c num_persone_tot!=""] per [num_persone_tot] persone[/c][r5][c data_inizio="" & ultimo_pagamento="1"][metodo_pagamento][/c][/r5]}
\cell\pard\plain \intbl\ltrpar\s1{\*\hyphen2\hyphlead2\hyphtrail2\hyphmax0}\qr\rtlch\af1\afs24\lang255\ltrch\dbch\af1\langfe255\hich\f1\fs24\lang1040\loch\f1\fs24\lang1040 {\rtlch \ltrch\loch\f1\fs24\lang1040\i0\b0 [r5][c mostra_metodo_ricev="1" & ultimo_pagamento="1"][nome_valuta] [valore_pagamento_p][/c][/r5]}
\cell\row\pard \trowd\trql\trleft276\trrh-119\trpaddft3\trpaddt55\trpaddfl3\trpaddl55\trpaddfb3\trpaddb55\trpaddfr3\trpaddr55\clbrdrt\brdrs\brdrw1\brdrcf1\clbrdrb\brdrs\brdrw1\brdrcf1\clcbpat3\cellx7792\clbrdrt\brdrs\brdrw1\brdrcf1\clbrdrb\brdrs\brdrw1\brdrcf1\clcbpat3\clvertalb\cellx9637
\pard\intbl\pard\plain \intbl\ltrpar\s1{\*\hyphen2\hyphlead2\hyphtrail2\hyphmax0}\ql\rtlch\af1\afs12\lang255\ltrch\dbch\af1\langfe255\hich\f1\fs12\lang1040\loch\f1\fs12\lang1040 
\cell\pard\plain \intbl\ltrpar\s1{\*\hyphen2\hyphlead2\hyphtrail2\hyphmax0}\qr\rtlch\af1\afs24\lang255\ltrch\dbch\af1\langfe255\hich\f1\fs24\lang1040\loch\f1\fs24\lang1040 
\cell\row\pard \trowd\trql\trleft276\trpaddft3\trpaddt55\trpaddfl3\trpaddl55\trpaddfb3\trpaddb55\trpaddfr3\trpaddr55\clbrdrt\brdrs\brdrw1\brdrcf1\clbrdrl\brdrs\brdrw1\brdrcf1\clbrdrb\brdrs\brdrw1\brdrcf1\clbrdrr\brdrs\brdrw1\brdrcf1\clcbpat4\cellx7792\clbrdrt\brdrs\brdrw1\brdrcf1\clbrdrb\brdrs\brdrw1\brdrcf1\clbrdrr\brdrs\brdrw1\brdrcf1\clcbpat4\clvertalb\cellx9637
...
\cell\pard\plain \intbl\ltrpar\s1\cf0\qr\rtlch\afs24\lang255\ab\ltrch\dbch\langfe255\hich\fs24\lang1040\b\loch\fs24\lang1040\b {\rtlch \ltrch\loch\f1\fs24\lang1040\i0\b [nome_valuta] [r5][c ultimo_pagamento="1"][valore_pagamento_p][/c][/r5]}
\cell\row\pard \pard\plain \ltrpar\s1\cf0\ql\rtlch\afs24\lang255\ltrch\dbch\langfe255\hich\fs24\lang1040\loch\fs24\lang1040 
\par \pard\plain \ltrpar\s1{\*\hyphen2\hyphlead2\hyphtrail2\hyphmax0}\rtlch\af1\afs24\lang255\ltrch\dbch\af1\langfe255\hich\f1\fs24\lang1040\loch\f1\fs24\lang1040 
\par \pard\plain \ltrpar\s1{\*\hyphen2\hyphlead2\hyphtrail2\hyphmax0}\brdrb\brdrs\brdrw20\brdrcf1\brsp20{\*\brdrb\brdlncol1\brdlnin0\brdlnout20\brdlndist0}\brsp20\ql\rtlch\af1\afs24\lang255\ltrch\dbch\af1\langfe255\hich\f1\fs24\lang1040\loch\f1\fs24\lang1040 
\par \pard\plain \ltrpar\s1{\*\hyphen2\hyphlead2\hyphtrail2\hyphmax0}\ql\rtlch\af1\afs24\lang255\ltrch\dbch\af1\langfe255\hich\f1\fs24\lang1040\loch\f1\fs24\lang1040 
...
<div class="riquadro_fattura" style="width: 780px; margin-left: 10px; margin-right: 10px; border: solid 1px black; padding: 30px; font-size: 12px;">
[r][r3][/r3] [/r]
...
<table class="voci_fattura" border="1" cellpadding="5" style="border: 1px black solid; width: 740px; margin-left: auto; margin-right: 5px; margin-top: 8px; border-collapse: collapse; background-color: #e6e6e6;">
<tr><td style="border-color: black;">[c data_inizio!=""]Prenotazione dal [data_inizio] al [data_fine][/c][c num_persone_tot!=""] per [num_persone_tot] persone[/c][r5][c data_inizio="" & ultimo_pagamento="1"][metodo_pagamento][/c][/r5]</td>
<td style="width: 120px; text-align: right; border-color: black;">[r5][c mostra_metodo_ricev="1" & ultimo_pagamento="1"][nome_valuta] [valore_pagamento_p][/c][/r5]</td></tr>
</table>

<table class="totale_fattura" border="1" cellpadding="5" style="border: 1px black solid; width: 740px; margin-left: auto; margin-right: 5px; margin-top: 8px; border-collapse: collapse; background-color: #cccccc;">
<tr><td style="border-color: black;">Totale Pagamento</td>
<td style="width: 120px; text-align: right; border-color: black;">[nome_valuta] [r5][c ultimo_pagamento="1"][valore_pagamento_p][/c][/r5]</td></tr>
</table>
...
<riga><cmp>5</cmp><cmp>cond9</cmp><cmp>rpt#@?#$?ultima_prenotazione_per_cliente#%?=#%?txt#%?1#@?break#%?cont</cmp></riga>
<riga><cmp>6</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65487#%?.=#%?var#%?url_base_pagine_web#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>7</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65487#%?.=#%?txt#%?mdl_conferma_prenotazione.php?cn=#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>8</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65487#%?.=#%?var#%?cogn_no_sp_ec#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>9</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65487#%?.=#%?txt#%?&cp=#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>10</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65487#%?.=#%?var#%?codice_prenotazione#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>11</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65487#%?.=#%?var#%?ritorno_a_capo#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>12</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65487#%?.=#%?var#%?ritorno_a_capo#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>13</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65488#%?=#%?var#%?arr_link_ec(numero_cliente)#%?txt#%?mdl_conferma_prenotazione.php?cn=#%?txt#%?confirm_reservation_tpl.php?cn=#%?</cmp></riga>
<riga><cmp>14</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65489#%?.=#%?txt#%?Cognome: #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>15</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65489#%?.=#%?var#%?cognome#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>16</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65489#%?.=#%?var#%?ritorno_a_capo#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>17</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65489#%?.=#%?txt#%?Codice prenotazione: #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>18</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65489#%?.=#%?var#%?codice_prenotazione#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>19</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65489#%?.=#%?var#%?ritorno_a_capo#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>20</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65489#%?.=#%?var#%?ritorno_a_capo#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>21</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65490#%?=#%?var#%?arr_dati_accesso_ec(numero_cliente)#%?txt#%?Cognome:#%?txt#%?Surname:#%?</cmp></riga>
<riga><cmp>22</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?set#%?a65490#%?=#%?var#%?arr_dati_accesso_en_ec(numero_cliente)#%?txt#%?Codice prenotazione:#%?txt#%?Reservation code:#%?</cmp></riga>
<riga><cmp>23</cmp><cmp>cond9</cmp><cmp>rpt#@?#@?cont</cmp></riga>
<riga><cmp>24</cmp><cmp>cond9</cmp><cmp>rpt#@?#$?ultima_prenotazione_per_cliente#%?!=#%?txt#%?1#@?set#%?-2#%?=#%?txt#%?1#%?txt#%?#%?txt#%?#%?</cmp></riga>
...
<riga><cmp>115</cmp><cmp>cond5</cmp><cmp>rpa#@?and#$?data_inizio#%?=#%?txt#%?#$?ultimo_pagamento#%?=#%?txt#%?1#$?metodo_pagamento#%?!=#%?txt#%?#@?set#%?152#%?=#%?txt#%?1#%?txt#%?#%?txt#%?#%?</cmp></riga>
...
<riga><cmp>242</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?set#%?490#%?=#%?var#%?oggi#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>243</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?trunc#%?490#%?4#%?#%?ini</cmp></riga>
<riga><cmp>244</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?oper#%?490#%?numero_invio_fael#%?-#%?txt#%?2020#%?</cmp></riga>
<riga><cmp>245</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?set#%?490#%?=#%?var#%?numero_invio_fael#%?txt#%?#%?txt#%?#%?0c3</cmp></riga>
<riga><cmp>246</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?oper#%?358#%?numero_progressivo_documento#%?*#%?txt#%?2#%?</cmp></riga>
<riga><cmp>247</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?set#%?358#%?=#%?var#%?var_tmp_fael#%?txt#%?#%?txt#%?#%?0c3</cmp></riga>
<riga><cmp>248</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?trunc#%?358#%?4#%?0#%?ini</cmp></riga>
<riga><cmp>249</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?set#%?490#%?.=#%?var#%?var_tmp_fael#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>250</cmp><cmp>cond4</cmp><cmp>rpt#@?#$?partita_iva_struttura#%?=#%?txt#%?#@?break#%?cont</cmp></riga>
<riga><cmp>251</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?set#%?-3#%?=#%?txt#%?IT#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>252</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?set#%?-3#%?.=#%?var#%?partita_iva_struttura#%?txt#%?IT#%?txt#%?#%?</cmp></riga>
<riga><cmp>253</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?set#%?-3#%?.=#%?txt#%?_#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>254</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?set#%?-3#%?.=#%?var#%?numero_invio_fael#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>255</cmp><cmp>cond4</cmp><cmp>rpt#@?#@?cont</cmp></riga>
<riga><cmp>1</cmp><cmp>cond22</cmp><cmp>ind#@?#@?array#%?a65485#%?dat#%?</cmp></riga>
<riga><cmp>2</cmp><cmp>cond22</cmp><cmp>ind#@?#@?set#%?488#%?=#%?txt#%?0#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>4</cmp><cmp>cond22</cmp><cmp>rpt#@?#$?date_isa(data_isa)#%?!=#%?var#%?data_fine#@?oper#%?488#%?presenze_isa#%?+#%?var#%?num_persone_tot#%?</cmp></riga>
...
<riga><cmp>36</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?numero_ospite#%?=#%?txt#%?1#@?set#%?491#%?=#%?var#%?codice_nazione_ross#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>37</cmp><cmp>cond19</cmp><cmp>rpt#@?and#$?numero_ospite#%?>#%?txt#%?1#$?codice_nazione_ross#%?=#%?txt#%?#@?set#%?481#%?=#%?var#%?codice_nazione1_ross#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>38</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?482#%?=#%?var#%?codice2_nazione_nascita_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>39</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?480#%?=#%?var#%?codice_nazione_nascita_ross#%?txt#%?1#%?txt#%?#%?</cmp></riga>
<riga><cmp>40</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?tmp_ross#%?=#%?var#%?codice_nazione_nascita_ross#@?set#%?482#%?=#%?var#%?codice_nazione_nascita_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>41</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?483#%?=#%?var#%?codice2_nazione_documento_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>42</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?480#%?=#%?var#%?codice_nazione_documento_ross#%?txt#%?1#%?txt#%?#%?</cmp></riga>
<riga><cmp>43</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?tmp_ross#%?=#%?var#%?codice_nazione_documento_ross#@?set#%?483#%?=#%?var#%?codice_nazione_documento_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>44</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?484#%?=#%?var#%?codice2_cittadinanza_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>46</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_cittadinanza_ospite#%?{}#%?txt#%?1#@?set#%?484#%?=#%?var#%?codice_cittadinanza_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>48</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_nazione_nascita_ross#%?!=#%?txt#%?100000100#@?set#%?459#%?=#%?txt#%?         #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>49</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_nazione_nascita_ross#%?=#%?txt#%?100000100#@?set#%?459#%?=#%?var#%?codice_citta_nascita_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>50</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_nazione_nascita_ross#%?!=#%?txt#%?100000100#@?set#%?460#%?=#%?txt#%?  #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>51</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_nazione_nascita_ross#%?=#%?txt#%?100000100#@?set#%?460#%?=#%?var#%?codice_regione_nascita_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>53</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_nazione_ross#%?!=#%?txt#%?100000100#@?set#%?461#%?=#%?txt#%?         #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>54</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_nazione_ross#%?=#%?txt#%?100000100#@?set#%?461#%?=#%?var#%?codice_citta_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>56</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?numero_ospite#%?=#%?txt#%?1#@?set#%?493#%?=#%?var#%?comune_resid_ross#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>57</cmp><cmp>cond19</cmp><cmp>rpt#@?and#$?numero_ospite#%?>#%?txt#%?1#$?comune_resid_ross#%?=#%?txt#%?#@?set#%?461#%?=#%?var#%?comune_resid1_ross#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>58</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_nazione_ross#%?!=#%?txt#%?100000100#@?set#%?462#%?=#%?txt#%?  #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>59</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_nazione_ross#%?=#%?txt#%?100000100#@?set#%?462#%?=#%?var#%?codice_regione_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>60</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?numero_ospite#%?=#%?txt#%?1#@?set#%?492#%?=#%?var#%?provincia_resid_ross#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>62</cmp><cmp>cond19</cmp><cmp>rpt#@?and#$?numero_ospite#%?>#%?txt#%?1#$?provincia_resid_ross#%?=#%?txt#%?#@?set#%?462#%?=#%?var#%?provincia_resid1_ross#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>63</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?463#%?=#%?var#%?codice_nazione_ross#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>64</cmp><cmp>cond19</cmp><cmp>rpt#@?or#$?numero_ospite#%?!=#%?txt#%?1#$?prenota_in_gruppo_ross(num_prenota_tmp_ross)#%?=#%?txt#%?1#@?set#%?463#%?=#%?txt#%?         #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>65</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?464#%?=#%?var#%?via_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>66</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?numcivico_ospite#%?!=#%?txt#%?#@?set#%?464#%?.=#%?txt#%? #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>67</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?numcivico_ospite#%?!=#%?txt#%?#@?set#%?464#%?.=#%?var#%?numcivico_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>68</cmp><cmp>cond19</cmp><cmp>rpt#@?or#$?numero_ospite#%?!=#%?txt#%?1#$?prenota_in_gruppo_ross(num_prenota_tmp_ross)#%?=#%?txt#%?1#@?set#%?464#%?=#%?txt#%? #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>69</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?trunc#%?464#%?50#%? #%?fin</cmp></riga>
<riga><cmp>70</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?465#%?=#%?var#%?codice_tipo_documento_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>71</cmp><cmp>cond19</cmp><cmp>rpt#@?or#$?numero_ospite#%?!=#%?txt#%?1#$?prenota_in_gruppo_ross(num_prenota_tmp_ross)#%?=#%?txt#%?1#@?set#%?465#%?=#%?txt#%?     #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>72</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?466#%?=#%?var#%?documento_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>73</cmp><cmp>cond19</cmp><cmp>rpt#@?or#$?numero_ospite#%?!=#%?txt#%?1#$?prenota_in_gruppo_ross(num_prenota_tmp_ross)#%?=#%?txt#%?1#@?set#%?466#%?=#%?txt#%? #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>74</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?trunc#%?466#%?20#%? #%?fin</cmp></riga>
<riga><cmp>75</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_nazione_documento_ross#%?!=#%?txt#%?100000100#@?set#%?467#%?=#%?var#%?codice_nazione_documento_ross#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>76</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_nazione_documento_ross#%?=#%?txt#%?100000100#@?set#%?467#%?=#%?var#%?comune_resid_ross#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>77</cmp><cmp>cond19</cmp><cmp>rpt#@?and#$?codice_nazione_documento_ross#%?=#%?txt#%?100000100#$?codice_citta_documento_ospite#%?!=#%?txt#%?#@?set#%?467#%?=#%?var#%?codice_citta_documento_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>78</cmp><cmp>cond19</cmp><cmp>rpt#@?or#$?numero_ospite#%?!=#%?txt#%?1#$?prenota_in_gruppo_ross(num_prenota_tmp_ross)#%?=#%?txt#%?1#@?set#%?467#%?=#%?txt#%?         #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>79</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?468#%?=#%?var#%?ritorno_a_capo#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>82</cmp><cmp>cond19</cmp><cmp>rpt#@?and#$?numero_ripetizione_prenotazioni#%?=#%?txt#%?1#$?numero_ospite#%?=#%?txt#%?1#@?set#%?468#%?=#%?txt#%?#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>83</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?acapo_ross#%?!=#%?txt#%?#@?set#%?468#%?.=#%?var#%?avanzamento_riga#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>84</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?475#%?=#%?var#%?data_inizio#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>85</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?476#%?=#%?var#%?data_fine#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>86</cmp><cmp>cond19</cmp><cmp>rpt#@?and#$?cognome_prec_ross#%?=#%?var#%?cognome#$?nome_prec_ross#%?=#%?var#%?nome#$?dataini_prec_ross#%?=#%?var#%?dataini_corr_ross#$?datafine_prec_ross#%?=#%?var#%?datafine_corr_ross#$?numero_ospite#%?=#%?txt#%?1#$?commento#%?=#%?txt#%?togliere questo se per  raggruppare più prenotazioni#@?set#%?a65483#%?=#%?txt#%?1#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>87</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?474#%?=#%?var#%?num_prenota_prec_ross#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>88</cmp><cmp>cond19</cmp><cmp>rpt#@?and#$?cognome_prec_ross#%?=#%?var#%?cognome#$?nome_prec_ross#%?=#%?var#%?nome#$?dataini_prec_ross#%?=#%?var#%?dataini_corr_ross#$?datafine_prec_ross#%?=#%?var#%?datafine_corr_ross#$?prenota_in_gruppo_ross(num_prenota_tmp_ross)#%?!=#%?txt#%?1#$?numero_ospite#%?=#%?txt#%?1#@?set#%?a65482#%?=#%?txt#%?1#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>89</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?469#%?=#%?var#%?cognome#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>90</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?470#%?=#%?var#%?nome#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>91</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?471#%?=#%?var#%?data_inizio#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>92</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?472#%?=#%?var#%?data_fine#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>93</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?473#%?=#%?var#%?numero_prenotazione#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>94</cmp><cmp>cond19</cmp><cmp>inr#@?#@?set#%?469#%?=#%?txt#%?#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>95</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?num_ripetizione_ross#%?>#%?txt#%?1#@?break#%?</cmp></riga>
<riga><cmp>96</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?474#%?=#%?var#%?numero_prenotazione#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>97</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?486#%?=#%?var#%?numero_prenotazione#%?txt#%?#%?txt#%?#%?asc</cmp></riga>
<riga><cmp>98</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?trunc#%?486#%?9#%?0#%?fin</cmp></riga>
<riga><cmp>99</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?478#%?=#%?txt#%?#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>100</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?nome_ospite#%?=#%?txt#%?#@?set#%?478#%?.=#%?txt#%?nome mancante,#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>101</cmp><cmp>cond19</cmp><cmp>rpt#@?or#$?data_nascita_ross#%?=#%?txt#%?#$?data_nascita_ross#%?=#%?txt#%?//#@?set#%?478#%?.=#%?txt#%?data nascita mancante, #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>103</cmp><cmp>cond19</cmp><cmp>ind#@?#@?set#%?477#%?=#%?txt#%?0#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>104</cmp><cmp>cond19</cmp><cmp>inr#@?#@?oper#%?477#%?num_ripetizione_ross#%?+#%?txt#%?1#%?</cmp></riga>
<riga><cmp>105</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_cittadinanza_ross#%?=#%?txt#%?#@?set#%?478#%?.=#%?txt#%?nazione di cittadinanza mancante, #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>111</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_nazione_nascita_ross#%?=#%?txt#%?#@?set#%?478#%?.=#%?txt#%?nazione di nascita mancante, #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>112</cmp><cmp>cond19</cmp><cmp>rpt#@?and#$?codice_nazione_nascita_ross#%?=#%?txt#%?100000100#$?codice_regione_nascita_ospite#%?=#%?txt#%?#@?set#%?478#%?.=#%?txt#%?provincia di nascita mancante, #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>113</cmp><cmp>cond19</cmp><cmp>rpt#@?and#$?codice_nazione_nascita_ross#%?=#%?txt#%?100000100#$?codice_citta_nascita_ospite#%?=#%?txt#%?#@?set#%?478#%?.=#%?txt#%?città di nascita mancante, #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>114</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?codice_nazione_ross#%?=#%?txt#%?#@?set#%?478#%?.=#%?txt#%?nazione di residenza mancante, #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>115</cmp><cmp>cond19</cmp><cmp>rpt#@?and#$?provincia_resid_ross#%?=#%?txt#%?#$?codice_nazione_ross#%?=#%?txt#%?100000100#@?set#%?478#%?.=#%?txt#%?provincia di residenza mancante, #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>116</cmp><cmp>cond19</cmp><cmp>rpt#@?and#$?comune_resid_ross#%?=#%?txt#%?#$?codice_nazione_ross#%?=#%?txt#%?100000100#@?set#%?478#%?.=#%?txt#%?città di residenza mancante, #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>117</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?mess_errore_ross#%?=#%?txt#%?#@?break#%?</cmp></riga>
<riga><cmp>118</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?-1#%?.=#%?txt#%?Prenotazione <b>#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>119</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?-1#%?.=#%?var#%?numero_prenotazione#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>120</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?-1#%?.=#%?txt#%?</b> ospite <b>#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>121</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?-1#%?.=#%?var#%?numero_ospite#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>122</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?-1#%?.=#%?txt#%?</b>: #%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>123</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?-1#%?.=#%?var#%?mess_errore_ross#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>124</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?-1#%?.=#%?txt#%?<br>#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>125</cmp><cmp>cond19</cmp><cmp>rpt#@?#@?set#%?480#%?=#%?var#%?mess_errore_ross#%?txt#%?città#%?txt#%?#%?</cmp></riga>
<riga><cmp>126</cmp><cmp>cond19</cmp><cmp>rpt#@?#$?tmp_ross#%?!=#%?var#%?mess_errore_ross#@?set#%?-1#%?.=#%?txt#%?<br>Si ricorda che per usare questo documento vanno prima ripristinate le <b>città predefinite</b> in "<em>configura e personalizza</em>", selezionando poi la città dal menù a tendina per ogni ospite italiano.<br>#%?txt#%?#%?txt#%?#%?</cmp></riga>
...
<riga><cmp>78</cmp><cmp>cond17</cmp><cmp>rpt#@?#$?cliente_mostrato_csv(numero_cliente)#%?=#%?txt#%?1#@?set#%?-2#%?=#%?txt#%?1#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>79</cmp><cmp>cond17</cmp><cmp>rpt#@?#@?set#%?a65486#%?=#%?txt#%?1#%?txt#%?#%?txt#%?#%?</cmp></riga>
...
<riga><cmp>54</cmp><cmp>cond11</cmp><cmp>rca#@?#@?set#%?343#%?=#%?txt#%?0#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>55</cmp><cmp>cond11</cmp><cmp>rca#@?#$?giorni_costo_agg#%?{A}#%?txt#%?,#@?set#%?343#%?=#%?txt#%?1#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>56</cmp><cmp>cond11</cmp><cmp>rca#@?#$?var_tmp_pulizie#%?=#%?txt#%?0#@?break#%?cont</cmp></riga>
<riga><cmp>57</cmp><cmp>cond11</cmp><cmp>rca#@?#$?pos_ca_pulizie(nome_costo_agg)#%?=#%?txt#%?#@?oper#%?341#%?num_ca_pulizie#%?+#%?txt#%?1#%?</cmp></riga>
<riga><cmp>58</cmp><cmp>cond11</cmp><cmp>rca#@?#$?pos_ca_pulizie(nome_costo_agg)#%?=#%?txt#%?#@?set#%?a4645#%?=#%?var#%?nome_costo_agg#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>59</cmp><cmp>cond11</cmp><cmp>ind#@?#@?set#%?342#%?=#%?txt#%?0#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>60</cmp><cmp>cond11</cmp><cmp>inr#@?#@?oper#%?342#%?numero_ripetizione_pulizie#%?+#%?txt#%?1#%?</cmp></riga>
<riga><cmp>61</cmp><cmp>cond11</cmp><cmp>rca#@?#$?pos_ca_pulizie(nome_costo_agg)#%?=#%?txt#%?#@?set#%?a4646#%?=#%?var#%?num_ca_pulizie#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>62</cmp><cmp>cond11</cmp><cmp>rca#@?#@?cont</cmp></riga>
<riga><cmp>63</cmp><cmp>cond11</cmp><cmp>run#@?#@?set#%?343#%?=#%?txt#%?0#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>64</cmp><cmp>cond11</cmp><cmp>run#@?#$?classe_riga_pulizie#%?!=#%?txt#%?#@?set#%?343#%?=#%?txt#%?1#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>65</cmp><cmp>cond11</cmp><cmp>run#@?#$?var_tmp_pulizie#%?!=#%?txt#%?1#@?set#%?336#%?=#%?txt#%? class="bgclr"#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>66</cmp><cmp>cond11</cmp><cmp>run#@?#$?var_tmp_pulizie#%?=#%?txt#%?1#@?set#%?336#%?=#%?txt#%?#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>67</cmp><cmp>cond11</cmp><cmp>rar4645#@?#@?set#%?344#%?.=#%?txt#%?<td><small><small>#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>68</cmp><cmp>cond11</cmp><cmp>rar4645#@?#@?set#%?344#%?.=#%?var#%?costi_aggiuntivi_pulizie(num_ca_pulizie)#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>69</cmp><cmp>cond11</cmp><cmp>rar4645#@?#@?set#%?344#%?.=#%?txt#%?</small></small></td>#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>71</cmp><cmp>cond11</cmp><cmp>rar4645#@?#@?set#%?345#%?.=#%?txt#%?<td><!-- cost#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>72</cmp><cmp>cond11</cmp><cmp>rar4645#@?#@?set#%?345#%?.=#%?var#%?num_ca_pulizie#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>73</cmp><cmp>cond11</cmp><cmp>rar4645#@?#@?set#%?345#%?.=#%?txt#%? --></td>#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>74</cmp><cmp>cond11</cmp><cmp>rca#@?#$?numero_ripetizione_pulizie#%?<#%?txt#%?2#@?break#%?cont</cmp></riga>
<riga><cmp>75</cmp><cmp>cond11</cmp><cmp>rca#@?#$?array_date_pulizie(giorno_pulizie)#%?!=#%?var#%?data_riepilogo_pulizie#@?break#%?cont</cmp></riga>
<riga><cmp>76</cmp><cmp>cond11</cmp><cmp>rca#@?#$?pos_ca_pulizie(nome_costo_agg)#%?=#%?txt#%?#@?break#%?cont</cmp></riga>
<riga><cmp>77</cmp><cmp>cond11</cmp><cmp>rca#@?#@?set#%?335#%?=#%?var#%?unita_occupata#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>78</cmp><cmp>cond11</cmp><cmp>rca#@?#$?riga_unita_ca_pulizie(unita_pulizie)#%?=#%?txt#%?#@?set#%?a4648#%?=#%?var#%?riga_ca_tabella_pulizie#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>79</cmp><cmp>cond11</cmp><cmp>ind#@?#@?array#%?a4649#%?dat#%?</cmp></riga>
<riga><cmp>80</cmp><cmp>cond11</cmp><cmp>rca#@?#@?set#%?343#%?=#%?txt#%?<!-- cost#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>82</cmp><cmp>cond11</cmp><cmp>rca#@?#@?set#%?343#%?.=#%?var#%?pos_ca_pulizie(nome_costo_agg)#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>83</cmp><cmp>cond11</cmp><cmp>rca#@?#@?set#%?343#%?.=#%?txt#%? -->#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>84</cmp><cmp>cond11</cmp><cmp>rca#@?#@?set#%?a4648#%?=#%?var#%?riga_unita_ca_pulizie(unita_pulizie)#%?var#%?var_tmp_pulizie#%?var#%?moltiplica_max_costo_agg#%?</cmp></riga>
<riga><cmp>85</cmp><cmp>cond11</cmp><cmp>rca#@?#@?set#%?341#%?=#%?var#%?pos_ca_pulizie(nome_costo_agg)#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>86</cmp><cmp>cond11</cmp><cmp>rca#@?#@?oper#%?a4650#%?totale_ca_pulizie(num_ca_pulizie)#%?+#%?var#%?moltiplica_max_costo_agg#%?</cmp></riga>
<riga><cmp>87</cmp><cmp>cond11</cmp><cmp>rca#@?#@?cont</cmp></riga>
<riga><cmp>88</cmp><cmp>cond11</cmp><cmp>run#@?#$?riga_unita_ca_pulizie(unita_pulizie)#%?=#%?txt#%?#@?set#%?a4648#%?=#%?var#%?riga_ca_tabella_pulizie#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>89</cmp><cmp>cond11</cmp><cmp>rpt#@?#$?data_inizio#%?=#%?var#%?data_riepilogo_pulizie#@?trunc#%?a4644#%?-3#%?#%?ini</cmp></riga>
<riga><cmp>90</cmp><cmp>cond11</cmp><cmp>rar4645#@?#@?set#%?a4650#%?=#%?txt#%?0#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>91</cmp><cmp>cond11</cmp><cmp>ind#@?#@?set#%?347#%?=#%?txt#%?<tr class="headrow"><td>Camera</td><td>Persone</td><td>Situazione</td><td><small><small>Persone in<br>partenza</small></small></td><td><small><small>Orario di<br>arrivo</small></small></td>#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>92</cmp><cmp>cond11</cmp><cmp>run#@?#@?oper#%?348#%?numero_ripetizione_unita_pulizie#%?+#%?txt#%?1#%?</cmp></riga>
<riga><cmp>93</cmp><cmp>cond11</cmp><cmp>run#@?#@?set#%?349#%?=#%?txt#%?#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>94</cmp><cmp>cond11</cmp><cmp>run#@?#$?numero_ripetizione_unita_pulizie#%?=#%?var#%?numero_ripetizione_riga_intestazione_pulizie#@?set#%?349#%?=#%?var#%?riga_intestazione_tabella_pulizie#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>95</cmp><cmp>cond11</cmp><cmp>run#@?#$?numero_ripetizione_unita_pulizie#%?=#%?var#%?numero_ripetizione_riga_intestazione_pulizie#@?set#%?349#%?.=#%?var#%?intestazione_ca_tabella_pulizie#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>96</cmp><cmp>cond11</cmp><cmp>run#@?#$?numero_ripetizione_unita_pulizie#%?=#%?var#%?numero_ripetizione_riga_intestazione_pulizie#@?set#%?349#%?.=#%?txt#%?</tr>#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>97</cmp><cmp>cond11</cmp><cmp>run#@?#$?numero_ripetizione_unita_pulizie#%?=#%?var#%?numero_ripetizione_riga_intestazione_pulizie#@?set#%?348#%?=#%?txt#%?0#%?txt#%?#%?txt#%?#%?</cmp></riga>
...
<riga><cmp>5</cmp><cmp>cond10</cmp><cmp>rpt#@?#$?ultima_prenotazione_per_cliente#%?=#%?txt#%?1#@?break#%?cont</cmp></riga>
<riga><cmp>6</cmp><cmp>cond10</cmp><cmp>rpt#@?#@?set#%?a65491#%?.=#%?var#%?url_base_pagine_web#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>7</cmp><cmp>cond10</cmp><cmp>rpt#@?#@?set#%?a65491#%?.=#%?txt#%?mdl_conferma_prenotazione.php?cn=#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>8</cmp><cmp>cond10</cmp><cmp>rpt#@?#@?set#%?a65491#%?.=#%?var#%?cogn_no_sp_eb#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>9</cmp><cmp>cond10</cmp><cmp>rpt#@?#@?set#%?a65491#%?.=#%?txt#%?&cp=#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>10</cmp><cmp>cond10</cmp><cmp>rpt#@?#@?set#%?a65491#%?.=#%?var#%?codice_prenotazione#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>11</cmp><cmp>cond10</cmp><cmp>rpt#@?#@?set#%?a65491#%?.=#%?txt#%?&fe=1#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>12</cmp><cmp>cond10</cmp><cmp>rpt#@?#@?set#%?a65491#%?.=#%?var#%?ritorno_a_capo#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>13</cmp><cmp>cond10</cmp><cmp>rpt#@?#@?set#%?a65491#%?.=#%?var#%?ritorno_a_capo#%?txt#%?#%?txt#%?#%?</cmp></riga>
<riga><cmp>14</cmp><cmp>cond10</cmp><cmp>rpt#@?#@?set#%?a65492#%?=#%?var#%?arr_link_eb(numero_cliente)#%?txt#%?mdl_conferma_prenotazione.php?cn=#%?txt#%?confirm_reservation_tpl.php?cn=#%?</cmp></riga>
<riga><cmp>15</cmp><cmp>cond10</cmp><cmp>rpt#@?#@?cont</cmp></riga>
<riga><cmp>16</cmp><cmp>cond10</cmp><cmp>rpt#@?#$?ultima_prenotazione_per_cliente#%?!=#%?txt#%?1#@?set#%?-2#%?=#%?txt#%?1#%?txt#%?#%?txt#%?#%?</cmp></riga>
